...
#Region "Connection"
            ...
            <LocalizedCategory("strCategoryConnection", 3), _
                LocalizedDisplayNameInheritAttribute("strSQLServername"), _
                LocalizedDescriptionInheritAttribute("strPropertyDescriptionDomain"), _
                TypeConverter(GetType(Tools.Misc.YesNoTypeConverter))> _
            Public Property SqlServerIP() As Boolean = My.Settings.InhDefaultDomain

            <LocalizedCategory("strCategoryConnection", 3), _
                LocalizedDisplayNameInheritAttribute("strSQLUserName"), _
                LocalizedDescriptionInheritAttribute("strPropertyDescriptionDomain"), _
                TypeConverter(GetType(Tools.Misc.YesNoTypeConverter))> _
            Public Property SqlServerUserName() As Boolean = My.Settings.InhDefaultDomain

            <LocalizedCategory("strCategoryConnection", 3), _
                LocalizedDisplayNameInheritAttribute("strSQLPassword"), _
                LocalizedDescriptionInheritAttribute("strPropertyDescriptionDomain"), _
                TypeConverter(GetType(Tools.Misc.YesNoTypeConverter))> _
            Public Property SqlServerPassword() As Boolean = My.Settings.InhDefaultDomain
#End Region
#Region "Protocol"
