...
#Region "Connection"
        ...
        Private _sqlServerIP As String = String.Empty
        <LocalizedCategory("strCategoryConnection", 2), _
            LocalizedDisplayName("strSQLServername"), _
            LocalizedDescription("strPropertyDescriptionDomain")> _
        Public Property SQLServerIP() As String
            Get
                Return GetInheritedPropertyValue("SqlServerIP", _sqlServerIP).Trim()
            End Get
            Set(ByVal value As String)
                _sqlServerIP = value.Trim()
            End Set
        End Property

        Private _sqlServerUserName As String = String.Empty
        <LocalizedCategory("strCategoryConnection", 2), _
            LocalizedDisplayName("strSQLUserName"), _
            LocalizedDescription("strPropertyDescriptionDomain")> _
        Public Property SQLServerUserName() As String
            Get
                Return GetInheritedPropertyValue("SqlServerUserName", _sqlServerUserName).Trim()
            End Get
            Set(ByVal value As String)
                _sqlServerUserName = value.Trim()
            End Set
        End Property

        Private _sqlServerPassword As String = String.Empty
        <LocalizedCategory("strCategoryConnection", 2), _
            LocalizedDisplayName("strSQLPassword"), _
            LocalizedDescription("strPropertyDescriptionDomain")> _
        Public Property SQLServerPassword() As String
            Get
                Return GetInheritedPropertyValue("SqlServerPassword", _sqlServerPassword).Trim()
            End Get
            Set(ByVal value As String)
                _sqlServerPassword = value.Trim()
            End Set
        End Property
#End Region
#Region "Protocol"
