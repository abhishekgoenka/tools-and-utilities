                ...
                Try
                    ...
                    Select Case mRemoteNG.Tree.Node.GetNodeType(selectedNode)
                        ...
                        Case mRemoteNG.Tree.Node.Type.Root
                            ...
                            CMemTreeConnectSql.Enabled = False
                            cMemTreeProfiler.Enabled = False
...
#Region "Context Menu Actions"
            ...
            Private Sub CMemTreeConnectSql_Click(sender As System.Object, e As System.EventArgs) Handles CMemTreeConnectSql.Click
                OpenSQLConnection()
                SaveConnectionsBG()
            End Sub

            Private Sub cMemTreeProfiler_Click(sender As Object, e As EventArgs) Handles cMemTreeProfiler.Click
                OpenSQLProfiler()
            End Sub
#End Region
