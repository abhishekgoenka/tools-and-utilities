                ...
                Try
                    With xxNode
                        If Me.confVersion > 0.1 Then '0.2
                            ...
                            conI.SQLServerIP = .Attributes("SqlServerIP").Value
                            conI.SQLServerUserName = .Attributes("SqlServerUserName").Value
                            conI.SQLServerPassword = .Attributes("SqlServerPassword").Value
