...
#Region "XML"
            ...
            Private Sub SaveToXml()
                Try
                    ...
                    Else
                        ...
                        Else
                            _xmlTextWriter.WriteAttributeString("Protected", "", Security.Crypt.Encrypt("ThisIsNotProtected", _password))
                            '_xmlTextWriter.WriteAttributeString("Protected", "", _password)
                        End If
                    End If
            ...
            Private Sub SaveConnectionFields(ByVal curConI As Connection.Info)
                Try
                    ...
                    _xmlTextWriter.WriteAttributeString("SqlServerIP", "", curConI.SQLServerIP)
                    _xmlTextWriter.WriteAttributeString("SqlServerUserName", "", curConI.SQLServerUserName)
                    _xmlTextWriter.WriteAttributeString("SqlServerPassword", "", curConI.SQLServerPassword)
